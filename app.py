...
# Lower resolution = smoother camera
CAMERA_WIDTH = 320
CAMERA_HEIGHT = 240
...
# FER runs in background every 4 seconds
EMOTION_INTERVAL_SECONDS = 4.0
...
class VideoProcessor(VideoProcessorBase):
    ...
    def __init__(self):
        ...
        self.session_attention = deque(
            maxlen=3000
        )

        self.session_confidence = deque(
            maxlen=3000
        )

        self.session_emotions = deque(
            maxlen=1000
        )
        ...
        while self.emotion_thread_running:
            ...
            with self.emotion_lock:
                ...
                if self.latest_face_crop is not None:
                    ...
                    crop = self.latest_face_crop.copy()
            ...
            # -----------------------------------------------
            # FER processing happens OUTSIDE camera thread
            # -----------------------------------------------
    ...
    def recv(self, frame):
        ...
        if results.multi_face_landmarks:
            ...
            # Only update the latest crop.
            # FER worker processes it separately.
...
# This keeps dashboard values updated without constantly
...
if ctx.state.playing:
    ...
    st_autorefresh(
        ...
        key="optimized_dashboard_refresh"
    )
